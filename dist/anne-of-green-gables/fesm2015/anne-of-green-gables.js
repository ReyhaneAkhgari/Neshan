...
import { Injectable, EventEmitter, Component, ViewEncapsulation, Input, Output, NgModule } from '@angular/core';

class AnneOfGreenGablesService {
    constructor() { }
}
AnneOfGreenGablesService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
AnneOfGreenGablesService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class AnneOfGreenGablesComponent {
    constructor() {
        this.key = '';
        this.center = [0, 0];
        this.zoom = 14;
...
class AnneOfGreenGablesModule {
}
AnneOfGreenGablesModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
AnneOfGreenGablesModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesModule, declarations: [AnneOfGreenGablesComponent], exports: [AnneOfGreenGablesComponent] });
AnneOfGreenGablesModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesModule, imports: [[]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.0", ngImport: i0, type: AnneOfGreenGablesModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
...
export { AnneOfGreenGablesComponent, AnneOfGreenGablesModule, AnneOfGreenGablesService, Point2D };
//# sourceMappingURL=anne-of-green-gables.js.map
