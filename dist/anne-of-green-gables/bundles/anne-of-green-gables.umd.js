(function (global, factory) {
    ...
    var AnneOfGreenGablesComponent = /** @class */ (function () {
        ...
        AnneOfGreenGablesComponent.prototype.ngAfterViewInit = function () {
            this.initMap();
        ...
        AnneOfGreenGablesComponent.prototype.concatMarkers = function (markers) {
            var _this = this;
            var markerStyle = { border: '0px', background: 'transparent' };
            markers.forEach(function (item) {
                var _iconDivSelect = leafletNeshan.divIcon({
                ...
                var _iconDivUnselect = leafletNeshan.divIcon({
                    html: '<div style="position:relative;text-align:center;width:35px;height:40px;">' +
                ...
                leafletNeshan.marker([item.lat, item.lng], { icon: _iconDivUnselect, alt: item.text }).on('click', function (ev) {
                    ...
                    markerLayers.forEach(function (element, index) {
                        if (element instanceof leafletNeshan.Marker) {
                            ...
                            element.setIcon(_iconDivUnselect_1);
                            if (element._latlng.lat == item.lat && element._latlng.lng == item.lng) {
                                element.setIcon(_iconDivSelect_1);
                                _this._map.flyTo(element._latlng);
        ...
        AnneOfGreenGablesComponent.prototype.concatMarkers2 = function (markers) {
            var _this = this;
            markers.forEach(function (item) {
        ...
        AnneOfGreenGablesComponent.prototype.selectDivIcon = function (item) {
            var markerStyle = { border: '0px', background: 'transparent' };
            var _iconDivSelect = leafletNeshan.divIcon({
                html: '<div style="position:relative;text-align:center;width:35px;height:40px;">'
                    + '<img src="src/assets/icons/marker-selected.png" style="width:35px;height:40px;"/>'
        ...
        AnneOfGreenGablesComponent.prototype.unSelectDivIcon = function (item) {
            var markerStyle = { border: '0px', background: 'transparent' };
            var _iconDivUnselect = leafletNeshan.divIcon({
                html: '<div style="position:relative;text-align:center;width:35px;height:40px;">'
                    + '<img src="src/assets/icons/marker-not-selected.png" style="width:35px;height:40px;"/>'
        ...
        AnneOfGreenGablesComponent.prototype.flyTo = function (item) {
            this._map.flyTo(item, this.zoom);
        };
        AnneOfGreenGablesComponent.prototype.removeMap = function () {
            this._map.remove();
        };
